...
namespace DiamondAssessmentSystem.Application.Services
{
    public class EmployeeService : IEmployeeService
    {
        ...
        public async Task<EmployeeDto> GetEmployeeByUserIdAsync(string userId)
        {
            ...
            dto.Role = roles.FirstOrDefault() ?? user.UserType; // Ưu tiên lấy từ roles của Identity
        ...
        public async Task<EmployeeDto> GetEmployeeByIdAsync(int employeeId)
        {
            ...
            {
                dto.Status = employee.User.Status;

                var roles = await _userManager.GetRolesAsync(employee.User);
                dto.Role = roles.FirstOrDefault() ?? employee.User.UserType;
            }
        ...
        //}
        public async Task<bool> UpdateEmployeeAsync(int employeeId, UpdateEmployeeDto updateDto, string currentUserId)
        {
            var employee = await _employeeRepository.GetEmployeeByIdAsync(employeeId);
